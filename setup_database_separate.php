...
try {
    ...
    // Create log_entries table (references students)
    ...
    $foreignKeys = [
        "ALTER TABLE users ADD CONSTRAINT fk_users_student FOREIGN KEY (reference_id) REFERENCES students(id) ON DELETE CASCADE",
        "ALTER TABLE users ADD CONSTRAINT fk_users_supervisor FOREIGN KEY (reference_id) REFERENCES supervisors(id) ON DELETE CASCADE", 
        "ALTER TABLE users ADD CONSTRAINT fk_users_coordinator FOREIGN KEY (reference_id) REFERENCES coordinators(id) ON DELETE CASCADE",
        "ALTER TABLE students ADD CONSTRAINT fk_students_supervisor FOREIGN KEY (supervisor_id) REFERENCES supervisors(id) ON DELETE SET NULL",
        "ALTER TABLE students ADD CONSTRAINT fk_students_coordinator FOREIGN KEY (coordinator_id) REFERENCES coordinators(id) ON DELETE SET NULL",
        "ALTER TABLE log_entries ADD CONSTRAINT fk_log_entries_student FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE",
        "ALTER TABLE weekly_summaries ADD CONSTRAINT fk_weekly_summaries_student FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE",
        "ALTER TABLE monthly_summaries ADD CONSTRAINT fk_monthly_summaries_student FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE",
        "ALTER TABLE evaluations ADD CONSTRAINT fk_evaluations_student FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE",
        "ALTER TABLE evaluations ADD CONSTRAINT fk_evaluations_supervisor FOREIGN KEY (supervisor_id) REFERENCES supervisors(id) ON DELETE CASCADE",
    ...
    $stmt = $pdo->prepare("INSERT INTO supervisors (full_name, email, phone, department, institution, position, specialization) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute(['Dr. Jane Smith', 'jane.smith@techsolutions.com', '08023456789', 'Computer Science', 'University of Nigeria', 'Senior Lecturer', 'Software Engineering']);
